...
import {
  ...
  updateExtension,
  validateAuthMethod
} from "./chunk-QJ33O2NH.js";
import {
  exitCli,
  require_source
} from "./chunk-YW7SDLZQ.js";
import {
  appEvents
...
import {
  ...
  saveModelChange,
  stripAnsi
} from "./chunk-7ZGWPQVZ.js";
import {
  RELAUNCH_EXIT_CODE
} from "./chunk-AOE6E7MU.js";
import "./chunk-TAWZWX2B.js";
import {
  cleanupCheckpoints,
  registerCleanup,
  registerSyncCleanup,
...
async function runNonInteractive({
  ...
  return promptIdContext.run(prompt_id, async () => {
    ...
    if (process.env["GEMINI_CLI_ACTIVITY_LOG_TARGET"]) {
      const { setupInitialActivityLogger } = await import("./devtoolsService-VQSLUOYF.js");
...
async function startInteractiveUI(config, settings, startupWarnings, workspaceRoot = process.cwd(), resumedSessionData, initializationResult) {
  const { startInteractiveUI: doStartUI } = await import("./interactiveCli-PP7WTUZL.js");
  await doStartUI(
    config,
    settings,
    startupWarnings,
...
${finalArgs[promptIndex + 1]}`;
  ...
  }
  {
    ...
    initAppHandle?.end();
    import("./liteRtServerManager-ZPDALIDY.js").then(({ LiteRtServerManager }) => {
